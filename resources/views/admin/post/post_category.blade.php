                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @foreach($category as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url("admin/post/category/edit/".$row->id)}}" class=" btn btn-sm btn-success">Edit </a>
                                    <a href="{{url("admin/post/category/delete/".$row->id)}}" class=" btn btn-sm btn-danger" id="delete">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
